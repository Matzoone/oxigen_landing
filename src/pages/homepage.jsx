...
function Homepage() {
    ...
    return (
        <div dir="rtl">
            <HeaderMobile />
            <div className="justify-between h-auto w-full mt-10 items-start flex max-sm:flex-col max-sm:hidden">
                <div className="h-9 w-full flex items-center justify-center  max-sm:flex-col max-sm:w-full">
                    <div className="flex justify-center items-center w-2/6 h-auto mr-10 max-sm:w-full">
                        ...
                        <h1 className="new_font text-3xl max-sm:text-xl max-lg:text-xl">تحریم شکن اکسیژن</h1>
                    </div>
                    <ul className="w-3/5 flex items-center justify-around max-sm:w-full">
                        <li><a className="font-yekan mr-0 max-sm:text-xs max-lg:text-xs"  onClick={handlePurchaseClick}>سرویس حجمی</a></li>
                        <li><a className="font-yekan max-sm:text-xs  max-lg:text-xs" onClick={handleScrollToSection2} name="#placev" href="#vip">سرویس اختصاصی</a></li>
                        <li><a className="font-yekan max-sm:text-xs  max-lg:text-xs" onClick={handleScrollToSection3} href="#fot" >تماس با ما</a></li>
                        <a className="pr-12 max-sm:text-xs max-lg:pr-6 max-lg:pl-6   max-lg:text-xs border-solid border-2 border-sky-500 rounded-3xl pl-12 pt-3 pb-3 botest font-yekan" > ورود و ثبت نام</a>                    </ul>
                </div>
            </div>
            <div className="flex w-full pb-12 items-center justify-around h-auto mr-32 mt-32 max-sm:mt-10 max-lg:mt-16 max-lg:flex-col pr-9 bg-image max-sm:flex-col max-sm:mr-0 max-sm:items-center max-sm:justify-around max-sm:w-full max-xl:mr-0">
                ...
                <div className="w-1/2 max-sm:hidden max-sm:flex-col max-sm:items-center max-sm:justify-center max-sm:ml-0 h-auto flex flex-col max-xl:items-start items-end justify-around">
                    <img className=" max-lg:mt-48 img-fix ml-56 mb-6 max-sm:ml-0 max-sm:mb-0 max-sm:mt-12" src={contentimage} alt="" />
                </div>
            </div>
            <div className="mt-40 text-3xl max-lg:mt-9 max-sm:text-2xl w-full flex max-sm:mt-32 items-center justify-center">
                <h2 ref={section2Ref} id="section-2" className="new_font ml-9 max-sm:ml-0">
            ...
            <div className="why_by_us flex w-full max-sm:flex-col max-sm:items-center justify-around items-center mt-28">
                <div className="w-1/2 max-sm:w-full flex flex-col items-start mr-36 max-sm:items-center max-sm:mr-0">
                    <span className="new_font text-4xl text-purple-800 max-sm:text-2xl">چرا سرویس اپ اختصاصی اکسیژن؟</span>
                    <span className="font-yekan text-2xl max-sm:text-lg mt-7">1.دارای حجم نامحدود</span>
            ...
            <div ref={purchaseSectionRef} id="purchase-section" className="mt-40 max-lg:mt-9 max-sm:text-lg max-sm:mt-32 text-3xl w-full flex items-center justify-center">
                <h2 className="new_font ml-9 max-sm:ml-0">
                    <a href="" name="volume">سرویس اپ حجمی برای ایفون و اندروید اکسیژن</a>
                </h2>
            </div>
            <div className="mt-16">
                <SliderVolume />
            ...
            <div className="why_by_us flex w-full max-sm:flex-col max-sm:items-center justify-around items-center mt-28">
                <div className="w-1/2 flex flex-col items-start mr-36 max-sm:mr-0 max-sm:w-full max-sm:items-center">
                    <span className="new_font text-4xl text-purple-800 max-sm:text-2xl">چرا سرویس اپ حجمی اکسیژن؟</span>
                    <span className="font-yekan text-2xl max-sm:text-base mt-7">1. به صورت جمعی و با تعداد کاربر نامحدود</span>
