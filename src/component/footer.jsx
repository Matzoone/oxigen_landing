            ...
            <div className="max-sm:w-full mt-10 flex-col  w-full flex justify-around items-center h-auto  pt-6 pr-1 pl-1 max-lg:flex-col max-sm:flex-col bg-image-footer">
                ...
                <div className="w-4/5 flex max-sm:flex-col  justify-around items-center h-auto p-8 border-b-2">
                    <div className="flex w-1/4 flex-col max-sm:w-full h-auto">
                        <p className="font-yekan text-white max-lg:text-sm max-sm:text-xs max-lg:leading-9 leading-9 text-sm">اکسیژن با رویکرد اعتماد به مشتری، با در اختیار داشتن متنوع ترین سرور ها متشکل از انواع آی پی های اقتصادی تا تجاری در سراسر کشور ایران آماده خدمت‌رسانی به مشتریان است.</p>
                    </div>
                    <div className="flex max-sm:w-full w-1/4 flex-col max-sm:mt-8 h-auto items-center">
                        ...
                        <a className="font-yekan text-sm text-white mt-8" href=""> سوالات متداول</a>
                        <a className="font-yekan text-sm text-white mt-8" href="">تماس با ما</a>
                        <a className="font-yekan text-sm text-white mt-8" href="">محصولات</a>
                    </div>
                    <div className="flex w-1/4 max-sm:w-full flex-col h-auto">
                        <a className="pl-1 flex items-center justify-center max-lg:pr-10 max-sm:pr-5 pr-1 pt-4 pb-4 rounded-3xl bg-blue-500 text-white new_font testserver mt-4 text-lg" href="#">اپ ویندوز</a>
                        <a className="pl-1 flex items-center justify-center max-lg:pr-10 max-sm:pr-5 pr-1 pt-4 pb-4 rounded-3xl bg-blue-500 text-white new_font testserver mt-4 text-lg" href="#">اپ ایفون</a>
                        <a className="pl- flex items-center justify-center max-lg:pr-10 max-sm:pr-5 pr-1 pt-4 pb-4 rounded-3xl bg-blue-500 text-white new_font testserver mt-4 text-lg" href="#">اپ اندروید</a>
                    </div>
                </div>
                <div className="flex w-full pr-36 mt-8 mb-7 ">
                    <img src={ruls} alt="" />
                    <p className="text-white new-font mr-3">تمامی حقوق این وبسایت متعلق به اکسیژن می‌باشد</p>
                </div>
            </div>
        </>
    )
