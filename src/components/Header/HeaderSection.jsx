const HeroSection = () => {
  return (
    <div className="flex items-center justify-center h-screen relative">
      ...
      <div className="relative z-10 backdrop-blur-lg bg-white/10 rounded-2xl p-8 max-w-3xl text-center text-white shadow-lg">
        ...
        <div className="mt-6 flex justify-center space-x-4 gap-6">
          <button className="bg-red-500 hover:bg-red-600 text-white px-8 transition hover:scale-110 py-1 rounded-3xl font-medium">
            خرید سرور
          </button>
          <button className="border border-gray-400 text-white px-8 transition hover:scale-110 py-1 rounded-3xl font-medium hover:bg-gray-700">
            تست رایگان
          </button>
        </div>
      </div>
